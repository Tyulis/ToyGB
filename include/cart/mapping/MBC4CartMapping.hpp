#ifndef _CART_MAPPING_MBC4CARTMAPPING_HPP
#define _CART_MAPPING_MBC4CARTMAPPING_HPP
...
namespace toygb {
	/** MBC4 ROM memory mapping
	 * TODO : Not implemented*/
	class MBC4CartMapping : public ROMMapping {
		public:
			...
			MBC4CartMapping(uint8_t carttype, std::string romfile, std::string ramfile, HardwareStatus* hardware);
			virtual ~MBC4CartMapping();
